package com.training.meeting.config.security.listeners;

import com.training.meeting.domain.user.LoginFailure;
import com.training.meeting.domain.user.User;
import com.training.meeting.repository.user.LoginFailureRepository;
...
public class AuthenticationFailureListener {
    ...
    private void lockUserAccount(User user) {
        List<LoginFailure> failures = loginFailureRepository.findAllByUserAndCreationDateIsAfter(user,
